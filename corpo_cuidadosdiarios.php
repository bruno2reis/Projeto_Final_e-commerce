...
<section class="container p-t-3">
	<div class="row">
		<div class="col-lg-12">
			<h3><span style="color: rgb(38,95,167)">Cuidados Diários</span></h3>
		</div>
	</div>
</section>
...
<div class="container" style="padding-bottom:0">
	<div class="row">	
		...
		<?php
			...
			$product_array = $shoppingCart->getProductByCategory(5);	/* Definir código da categoria para trazer na query */
